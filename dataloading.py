...
class TemporalSampler(BlockSampler):
    ...
    def __init__(self, sampler_type='topk', k=10):
        ...
        self.org_sampler = partial(dgl.sampling.sample_neighbors, fanout=k)
    ...
    def sample_blocks(self,
        ...
        frontier_loc = self.org_sampler(g=g_loc, nodes=seed_nodes)
        frontier_fri = self.org_sampler(g=g_fri, nodes=seed_nodes)
...
class TemporalEdgeCollator(EdgeCollator):
    ...
    def init(self, g, eids, graph_sampler, g_loc, g_fri, **collator_kwargs):
        super().__init__(g, eids, graph_sampler, **collator_kwargs)
        self.g_loc = g_loc
        self.g_fri = g_fri
    ...
    def _collate_with_negative_sampling(self, items):
        ...
        # print(pair_graph.edges())
        # print(neg_pair_graph.edges())
        # exit()
...
class TemporalEdgeDataLoader(EdgeDataLoader):
    ...
    def __init__(self, g, eids, graph_sampler, g_loc, g_fri, device='cpu', collator=TemporalEdgeCollator, **kwargs):
        ...
        self.collator = collator(g, eids, graph_sampler, g_loc, g_fri, **collator_kwargs)
